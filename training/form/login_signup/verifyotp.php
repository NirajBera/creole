    ...
    <center>
        <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
            <div class="container-fluid">
                ...
                <form class="d-flex">
                    ...
                    <button id="btn1" class="btn btn-primary rounded-3"><a href="login.php" id ="a1"> Log in</a></button>
        ...
        <form method="POST" class="container border border-secondary border-3 rounded-3 w-50 text-center d-flex flex-column justify-content-center cmxform" action="" id="vForm">
            ...
            <div class="mb-3">
                ...
                <input id="otp" class="form-control" name="otp" type="text"  class="error" required>
